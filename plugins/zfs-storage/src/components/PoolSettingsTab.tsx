        ...
        <CardBody>
          <Form onSubmit={handleSubmit}>
            <FormGroup label="Pool name" fieldId="pool-name">
              <TextInput id="pool-name" value={pool.name} readOnly />
            </FormGroup>

            <FormGroup label="Pool GUID" fieldId="pool-guid">
              <TextInput id="pool-guid" value={pool.guid || "-"} readOnly />
            </FormGroup>

            <FormGroup label="Sector size (ashift)" fieldId="pool-ashift">
              <TextInput id="pool-ashift" value={properties["ashift"] || "Auto"} readOnly />
            </FormGroup>
