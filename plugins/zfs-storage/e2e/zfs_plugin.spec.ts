...
test.describe.serial("Cockpit ZFS Storage Plugin E2E Test Suite", () => {
  ...
  test("3. Create Child Dataset and verify compression on filesystem", async () => {
    ...
    await frame.locator("[role='dialog'] button:has-text('Create Dataset'), .pf-v6-c-modal-box button:has-text('Create Dataset')").first().click();
  ...
  test("4. Create ZFS Volume (zvol) and verify device file on filesystem", async () => {
    ...
    await frame.locator("[role='dialog'] button:has-text('Create Volume'), .pf-v6-c-modal-box button:has-text('Create Volume')").first().click();
  ...
  test("5. Create ZFS Snapshot and verify in Snapshots tree & filesystem", async () => {
    ...
    if (await snapToggle.isVisible({ timeout: 3000 }).catch(() => false)) {
      ...
      if (await cloneOption.isVisible({ timeout: 2000 }).catch(() => false)) {
        ...
        const cloneSubmit = frame.locator("[role='dialog'] button:has-text('Clone Snapshot'), .pf-v6-c-modal-box button:has-text('Clone Snapshot')").first();
  ...
  test("7. Rename dataset and verify on filesystem", async () => {
    ...
    await frame.locator("[role='dialog'] button:has-text('Rename'), .pf-v6-c-modal-box button:has-text('Rename'), button:text-is('Rename')").first().click();
  ...
  test("8. Delete dataset and volume and verify on filesystem", async () => {
    ...
    await frame.locator("[role='dialog'] button:has-text('Permanently Destroy'), .pf-v6-c-modal-box button:has-text('Permanently Destroy'), button:text-is('Permanently Destroy')").first().click();
  ...
  test("18. Modal Lifecycle, Input Validation & Submission Suite", async () => {
    ...
    await frame.locator("[role='dialog'] button:has-text('Create dataset'), .pf-v6-c-modal-box button:has-text('Create dataset')").first().click({ timeout: 1000 }).catch(() => {});
    ...
    await page.waitForTimeout(200);
    await frame.locator("[role='dialog'] button:has-text('Create volume'), .pf-v6-c-modal-box button:has-text('Create volume')").first().click({ timeout: 1000 }).catch(() => {});
    ...
    await page.waitForTimeout(200);
    await frame.locator("[role='dialog'] button:has-text('Create snapshot'), .pf-v6-c-modal-box button:has-text('Create snapshot')").first().click({ timeout: 1000 }).catch(() => {});
    ...
    await page.waitForTimeout(200);
    await frame.locator("[role='dialog'] button:has-text('Clone snapshot'), .pf-v6-c-modal-box button:has-text('Clone snapshot')").first().click({ timeout: 1000 }).catch(() => {});
    ...
    await page.waitForTimeout(200);
    await frame.locator("[role='dialog'] button:has-text('Rename'), .pf-v6-c-modal-box button:has-text('Rename')").first().click({ timeout: 1000 }).catch(() => {});
  ...
  test("20. Create Pool Wizard Advanced Configuration Suite", async () => {
    ...
    if (await createPoolBtn.isVisible({ timeout: 3000 }).catch(() => false)) {
      ...
      const nextBtn = frame.locator("[role='dialog'] button:visible:has-text('Next')").first();
      ...
      const diskCheck = frame.locator("[class*='wizard'] input[type='checkbox'], input[type='checkbox']").first();
      ...
      const backBtn = frame.locator("[role='dialog'] button:visible:has-text('Back')").first();
      for (let i = 0; i < 4; i++) {
      ...
      const cancelBtn = frame.locator("[role='dialog'] button:visible:has-text('Cancel')").first();
  ...
  test("22. Direct Modal Form Controls & Operations Exercise", async () => {
    ...
    const closeDsBtn = frame.locator("[role='dialog'] button:has-text('Cancel'), .pf-v6-c-modal-box button:has-text('Cancel')").first();
    ...
    const closeZvolBtn = frame.locator("[role='dialog'] button:has-text('Cancel'), .pf-v6-c-modal-box button:has-text('Cancel')").first();
    ...
    const closeSnapBtn = frame.locator("[role='dialog'] button:has-text('Cancel'), .pf-v6-c-modal-box button:has-text('Cancel')").first();
  ...
  test("23. Disk & Property Dialog Interaction Suite", async () => {
    ...
    await page.waitForTimeout(200);
    const attachBtn = frame.locator("[role='dialog'] button:has-text('Attach Device'), .pf-v6-c-modal-box button:has-text('Attach Device')").first();
    if (await attachBtn.isVisible({ timeout: 1000 }).catch(() => false)) {
      await attachBtn.click({ timeout: 1000 }).catch(() => {});
    }
    const cancelAttach = frame.locator("[role='dialog'] button:has-text('Cancel'), .pf-v6-c-modal-box button:has-text('Cancel')").first();
    ...
    await page.waitForTimeout(200);
    const replaceBtn = frame.locator("[role='dialog'] button:has-text('Replace Device'), .pf-v6-c-modal-box button:has-text('Replace Device')").first();
    if (await replaceBtn.isVisible({ timeout: 1000 }).catch(() => false)) {
      await replaceBtn.click({ timeout: 1000 }).catch(() => {});
    }
    const cancelReplace = frame.locator("[role='dialog'] button:has-text('Cancel'), .pf-v6-c-modal-box button:has-text('Cancel')").first();
    ...
    const renameBtn = frame.locator("[role='dialog'] button:has-text('Rename'), .pf-v6-c-modal-box button:has-text('Rename')").first();
    if (await renameBtn.isVisible({ timeout: 1000 }).catch(() => false)) {
      await renameBtn.click({ timeout: 1000 }).catch(() => {});
    }
    const cancelRename = frame.locator("[role='dialog'] button:has-text('Cancel'), .pf-v6-c-modal-box button:has-text('Cancel')").first();
    ...
    const destroyBtn = frame.locator("[role='dialog'] button:has-text('Destroy'), .pf-v6-c-modal-box button:has-text('Destroy')").first();
    if (await destroyBtn.isVisible({ timeout: 1000 }).catch(() => false)) {
      await destroyBtn.click({ timeout: 1000 }).catch(() => {});
    }
    const cancelDestroy = frame.locator("[role='dialog'] button:has-text('Cancel'), .pf-v6-c-modal-box button:has-text('Cancel')").first();
    ...
    await page.waitForTimeout(200);
    const closeArc = frame.locator("[role='dialog'] button:has-text('Close'), .pf-v6-c-modal-box button:has-text('Close'), [role='dialog'] button:has-text('Cancel'), .pf-v6-c-modal-box button:has-text('Cancel')").first();
    ...
    await page.waitForTimeout(200);
    const cancelPreview = frame.locator("[role='dialog'] button:has-text('Cancel'), .pf-v6-c-modal-box button:has-text('Cancel')").first();
