...
test.describe.serial("Cockpit ZFS Storage Plugin E2E Test Suite", () => {
  ...
  test("2. Create ZFS Pool via Web UI Wizard and verify on filesystem", async () => {
    ...
    await frame.locator(".pf-v6-c-wizard__footer button:has-text('Next'), .pf-v5-c-wizard__footer button:has-text('Next'), [role='dialog'] button:has-text('Next')").first().click();
    ...
    await frame.locator(".pf-v6-c-wizard__footer button:has-text('Create'), .pf-v5-c-wizard__footer button:has-text('Create'), [role='dialog'] button:has-text('Create')").first().click();
  ...
  test("3. Create Child Dataset and verify compression on filesystem", async () => {
    ...
    await frame.locator(".pf-v6-c-modal-box button:has-text('Create Dataset')").first().click();
  ...
  test("4. Create ZFS Volume (zvol) and verify device file on filesystem", async () => {
    ...
    await frame.locator(".pf-v6-c-modal-box button:has-text('Create Volume')").first().click();
  ...
  test("5. Create ZFS Snapshot and verify in Snapshots tree & filesystem", async () => {
    ...
    await frame.locator(".pf-v6-c-modal-box button:has-text('Create Snapshot'), .pf-v6-c-modal-box button:has-text('Take Snapshot'), .pf-v6-c-modal-box button.pf-m-primary").first().click();
    ...
    const snapToggle = snapRow.locator("button[aria-label='Snapshot actions'], button.pf-v6-c-menu-toggle").first();
    if (await snapToggle.isVisible({ timeout: 3000 }).catch(() => false)) {
      ...
      if (await cloneOption.isVisible({ timeout: 2000 }).catch(() => false)) {
        ...
        const cloneSubmit = frame.locator(".pf-v6-c-modal-box button:has-text('Clone Snapshot')").first();
        if (await cloneSubmit.isVisible({ timeout: 2000 }).catch(() => false)) {
          await cloneSubmit.click();
          await expect(frame.locator(".pf-v6-c-modal-box")).toHaveCount(0, { timeout: 10000 });
        }
      }
    }
  });
  ...
  test("6. Start and monitor Scrub via Maintenance tab", async () => {
    ...
    const confirmBtn = frame.locator(".pf-v6-c-modal-box button:has-text('Execute Command'), .pf-v6-c-modal-box button:has-text('Execute'), .pf-v6-c-modal-box button.pf-m-primary").first();
  ...
  test("7. Rename dataset and verify on filesystem", async () => {
    ...
    await row.locator("button[aria-label=\"Dataset actions\"], button.pf-v6-c-menu-toggle").first().click();
    ...
    await frame.locator(".pf-v6-c-modal-box button:has-text('Rename'), button:text-is('Rename')").first().click();
  ...
  test("8. Delete dataset and volume and verify on filesystem", async () => {
    ...
    await frame.locator(".pf-v6-c-modal-box button:has-text('Permanently Destroy'), button:text-is('Permanently Destroy')").first().click();
  ...
  test("9. Verify Dark Mode Theme Synchronization in ZFS Storage", async () => {
    ...
    await expect(frame.locator("html.pf-v6-theme-dark, html.pf-v6-theme-dark, :root.pf-v6-theme-dark").first()).toBeAttached();
  ...
  test("13. ARC Cache Details Modal Inspection", async () => {
    ...
    if (await arcCard.isVisible({ timeout: 3000 }).catch(() => false)) {
      await arcCard.click();
      await page.waitForTimeout(500);
      const closeBtn = frame.locator(".pf-v6-c-modal-box button[aria-label='Close'], .pf-v6-c-modal-box button:has-text('Close')").first();
  ...
  test("14. SMART Disk Inspection Modal", async () => {
    ...
    const actionToggle = diskRow.locator("button[aria-label='Disk actions'], button.pf-v6-c-menu-toggle").first();
  ...
  test("15. Import Pool Modal Inspection", async () => {
    ...
    if (await importBtn.isVisible({ timeout: 3000 }).catch(() => false)) {
      ...
      await page.waitForTimeout(500);
      const cancelBtn = frame.locator(".pf-v6-c-modal-box button:has-text('Cancel'), .pf-v6-c-modal-box button[aria-label='Close']").first();
  ...
  test("18. Modal Lifecycle, Input Validation & Submission Suite", async () => {
    ...
    await frame.locator(".pf-v6-c-modal-box button:has-text('Create dataset')").first().click({ timeout: 1000 }).catch(() => {});
    ...
    await frame.locator(".pf-v6-c-modal-box button:has-text('Cancel')").first().click({ timeout: 1000 }).catch(() => {});
    ...
    await page.waitForTimeout(200);
    await frame.locator(".pf-v6-c-modal-box button:has-text('Create volume')").first().click({ timeout: 1000 }).catch(() => {});
    ...
    await page.waitForTimeout(200);
    await frame.locator(".pf-v6-c-modal-box button:has-text('Create snapshot')").first().click({ timeout: 1000 }).catch(() => {});
    ...
    await page.waitForTimeout(200);
    await frame.locator(".pf-v6-c-modal-box button:has-text('Clone snapshot')").first().click({ timeout: 1000 }).catch(() => {});
    ...
    await page.waitForTimeout(200);
    await frame.locator(".pf-v6-c-modal-box button:has-text('Rename')").first().click({ timeout: 1000 }).catch(() => {});
    ...
    await page.waitForTimeout(200);
    await frame.locator(".pf-v6-c-modal-box button[aria-label='Close'], .pf-v6-c-modal-box button:has-text('Close')").first().click({ timeout: 1000 }).catch(() => {});
  ...
  test("20. Create Pool Wizard Advanced Configuration Suite", async () => {
    ...
    if (await createPoolBtn.isVisible({ timeout: 3000 }).catch(() => false)) {
      ...
      const nextBtn = frame.locator(".pf-v6-c-wizard__footer button:has-text('Next')").first();
      ...
      const diskCheck = frame.locator(".pf-v6-c-wizard input[type='checkbox']").first();
      ...
      const backBtn = frame.locator(".pf-v6-c-wizard__footer button:has-text('Back')").first();
      for (let i = 0; i < 4; i++) {
      ...
      const cancelBtn = frame.locator(".pf-v6-c-wizard__footer button:has-text('Cancel')").first();
  ...
  test("22. Direct Modal Form Controls & Operations Exercise", async () => {
    ...
    const closeDsBtn = frame.locator(".pf-v6-c-modal-box button:has-text('Cancel')").first();
    ...
    const closeZvolBtn = frame.locator(".pf-v6-c-modal-box button:has-text('Cancel')").first();
    ...
    const closeSnapBtn = frame.locator(".pf-v6-c-modal-box button:has-text('Cancel')").first();
  ...
  test("23. Disk & Property Dialog Interaction Suite", async () => {
    ...
    await page.waitForTimeout(200);
    const attachBtn = frame.locator(".pf-v6-c-modal-box button:has-text('Attach Device')").first();
    if (await attachBtn.isVisible({ timeout: 1000 }).catch(() => false)) {
      await attachBtn.click({ timeout: 1000 }).catch(() => {});
    }
    const cancelAttach = frame.locator(".pf-v6-c-modal-box button:has-text('Cancel')").first();
    ...
    await page.waitForTimeout(200);
    const replaceBtn = frame.locator(".pf-v6-c-modal-box button:has-text('Replace Device')").first();
    if (await replaceBtn.isVisible({ timeout: 1000 }).catch(() => false)) {
      await replaceBtn.click({ timeout: 1000 }).catch(() => {});
    }
    const cancelReplace = frame.locator(".pf-v6-c-modal-box button:has-text('Cancel')").first();
    ...
    await page.waitForTimeout(200);
    const rollbackBtn = frame.locator(".pf-v6-c-modal-box button:has-text('Rollback Snapshot')").first();
    if (await rollbackBtn.isVisible({ timeout: 1000 }).catch(() => false)) {
      await rollbackBtn.click({ timeout: 1000 }).catch(() => {});
    }
    const cancelRollback = frame.locator(".pf-v6-c-modal-box button:has-text('Cancel')").first();
    ...
    const cloneBtn = frame.locator(".pf-v6-c-modal-box button:has-text('Clone Snapshot')").first();
    if (await cloneBtn.isVisible({ timeout: 1000 }).catch(() => false)) {
      await cloneBtn.click({ timeout: 1000 }).catch(() => {});
    }
    const cancelClone = frame.locator(".pf-v6-c-modal-box button:has-text('Cancel')").first();
    ...
    const renameBtn = frame.locator(".pf-v6-c-modal-box button:has-text('Rename')").first();
    if (await renameBtn.isVisible({ timeout: 1000 }).catch(() => false)) {
      await renameBtn.click({ timeout: 1000 }).catch(() => {});
    }
    const cancelRename = frame.locator(".pf-v6-c-modal-box button:has-text('Cancel')").first();
    ...
    const destroyBtn = frame.locator(".pf-v6-c-modal-box button:has-text('Destroy')").first();
    if (await destroyBtn.isVisible({ timeout: 1000 }).catch(() => false)) {
      await destroyBtn.click({ timeout: 1000 }).catch(() => {});
    }
    const cancelDestroy = frame.locator(".pf-v6-c-modal-box button:has-text('Cancel')").first();
    ...
    await page.waitForTimeout(200);
    const closeArc = frame.locator(".pf-v6-c-modal-box button:has-text('Close'), .pf-v6-c-modal-box button:has-text('Cancel')").first();
    ...
    await page.waitForTimeout(200);
    const cancelPreview = frame.locator(".pf-v6-c-modal-box button:has-text('Cancel')").first();
    ...
    await page.waitForTimeout(200);
    const savePropBtn = frame.locator(".pf-v6-c-modal-box button:has-text('Save changes'), .pf-v6-c-modal-box button:has-text('Save Changes')").first();
    if (await savePropBtn.isVisible({ timeout: 1000 }).catch(() => false)) {
      await savePropBtn.click({ timeout: 1000 }).catch(() => {});
    }
    const cancelEditProp = frame.locator(".pf-v6-c-modal-box button:has-text('Cancel')").first();
  ...
  test("26. Dataset and Snapshot Action Menus Suite", async () => {
    ...
    if (await dsKebab.isVisible({ timeout: 1000 }).catch(() => false)) {
      ...
      await page.waitForTimeout(200);
      const editPropItem = frame.locator("button.pf-v6-c-menu__item:has-text('Edit properties')").first();
      if (await editPropItem.isVisible({ timeout: 1000 }).catch(() => false)) {
        await editPropItem.click({ timeout: 1000 }).catch(() => {});
        await page.waitForTimeout(200);
        const cancelBtn = frame.locator(".pf-v6-c-modal-box button:has-text('Cancel')").first();
      ...
      await dsKebab.click({ timeout: 1000 }).catch(() => {});
      await page.waitForTimeout(200);
      const renameItem = frame.locator("button.pf-v6-c-menu__item:has-text('Rename')").first();
    ...
    if (await snapKebab.isVisible({ timeout: 1000 }).catch(() => false)) {
      ...
      await page.waitForTimeout(200);
      const cloneItem = frame.locator("button.pf-v6-c-menu__item:has-text('Clone to new dataset')").first();
  ...
  test("27. Comprehensive Views & Disks Traversal with Rich Mock State", async () => {
    ...
    if (await poolKebab.isVisible({ timeout: 1000 }).catch(() => false)) {
      ...
      await page.waitForTimeout(200);
      const scrubItem = frame.locator("button.pf-v6-c-menu__item:has-text('scrub'), button.pf-v6-c-menu__item:has-text('Scrub')").first();
      ...
      await poolKebab.click({ timeout: 1000 }).catch(() => {});
      await page.waitForTimeout(200);
      const trimItem = frame.locator("button.pf-v6-c-menu__item:has-text('trim'), button.pf-v6-c-menu__item:has-text('Trim')").first();
    ...
    if (await diskKebab.isVisible({ timeout: 1000 }).catch(() => false)) {
      ...
      await page.waitForTimeout(200);
      const shortTest = frame.locator("button.pf-v6-c-menu__item:has-text('short')").first();
      ...
      await diskKebab.click({ timeout: 1000 }).catch(() => {});
      await page.waitForTimeout(200);
      const longTest = frame.locator("button.pf-v6-c-menu__item:has-text('extended')").first();
    ...
    const expandDiskBtn = frame.locator("table[aria-label*='Disks'] button.pf-v6-c-table__toggle, table button[aria-label*='Details']").first();
    ...
    if (await smartDetailsBtn.isVisible({ timeout: 1000 }).catch(() => false)) {
      ...
      await page.waitForTimeout(200);
      const closeBtn = frame.locator(".pf-v6-c-modal-box button:has-text('Close')").first();
    ...
    if (await devKebab.isVisible({ timeout: 1000 }).catch(() => false)) {
      ...
      await page.waitForTimeout(200);
      const replaceItem = frame.locator("button.pf-v6-c-menu__item:has-text('Replace device')").first();
      ...
      await devKebab.click({ timeout: 1000 }).catch(() => {});
      await page.waitForTimeout(200);
      const trimDevItem = frame.locator("button.pf-v6-c-menu__item:has-text('Trim device')").first();
