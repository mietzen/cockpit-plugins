...
- `plugins/`: Cockpit plugin packages:
  - `plugins/zfs-storage/`: OpenZFS storage manager (`cockpit-zfs-storage`, v0.7.0).
  - `plugins/file-sharing/`: SMB & NFS manager (`cockpit-file-sharing`, v0.3.0).
  - `plugins/container-manager/`: Docker & Podman manager (`cockpit-container-manager`, v0.3.0).
